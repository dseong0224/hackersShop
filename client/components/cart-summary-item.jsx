  ...
  return (
    ...
    <div className="row align-items-center mt-1 mb-1">
      ...
      <div className="col-sm-7">
        ...
        <div>
          <button type="button" className="btn btn-light mr-3" onClick={viewDetails} role="button">View details</button>
          <button type="button" className="btn btn-light" role="button">Remove</button>
        </div>
      </div>
    </div>
  );
