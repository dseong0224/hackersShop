...
export default function CartSummary(props) {
  function listCartItems() {
    ...
    return (props.cart.map(cartItem => {
      return <CartSummaryItem key={cartItem.id} data={cartItem} viewCartItemDetails={props.setPage} getCartItems={props.getCartItems} remove={props.remove} updateCart={props.updateCart}/>;
    }));
  }
