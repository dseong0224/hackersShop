...
export default class Carousel extends React.Component {
  ...
  render() {
      ...
      <div id="carouselExampleCaptions" className="carousel slide text-dark" data-ride="carousel">
        ...
        <div className="carousel-inner d-flex justify-content-around">
          <div className="carousel-item active">
            <img height="500px" src="https://images-na.ssl-images-amazon.com/images/I/61umHSM6OhL._SL1200_.jpg" className="d-block .d-none" alt="..."/>
          ...
          <div className="carousel-item">
            <img height="500px" src="https://assets.logitech.com/assets/55384/k380-multi-device-bluetooth-keyboard.png" className="d-block .d-none" alt="..."/>
            <div className="carousel-caption d-none d-md-block text-dark">
              <h1>k380</h1>
              <p>Compact, lightweight, Bluetooth keyboard anywhere.</p>
          ...
          <div className="carousel-item">
            <img height="500px" src="https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/MLA22B?wid=2000&hei=2000&fmt=jpeg&qlt=95&op_usm=0.5%2C0.5&.v=1496943865511" className="d-block .d-none" alt="..."/>
            <div className="carousel-caption d-none d-md-block text-dark">
              <h1>Apple</h1>
    ...
    //         <p><a className="btn btn-lg btn-default border border-dark" style={{ cursor: 'pointer' }} role="button" onClick={this.detailForProduct1}>View Product</a></p>
    //       </div>
    //       <img height="45vh" src="https://images-na.ssl-images-amazon.com/images/I/61umHSM6OhL._SL1200_.jpg"/>
    //     </div>
    //     <div className="carousel-item">
